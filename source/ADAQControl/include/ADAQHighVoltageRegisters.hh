...
namespace V653X{
  ...
  const uint32_t  IMON[6] = {0x008c,  0x010c,  0x018c,  0x020c,  0x028c,  0x030c}; // Current monitor
  const uint32_t    PW[6] = {0x0090,  0x0110,  0x0190,  0x0210,  0x0290,  0x0310}; // Power
  const uint32_t SVMAX[6] = {0x009C,  0x011c,  0x019c,  0x021c,  0x029c,  0x031c}; // Voltage maximum (software)
