...
int main(int argc, char *argv[])
{
    ...
    // They will be used only if connected board is a DT5790
    ...
    while(!Quit) {
        ...
        if(kbhit()) {
            ...
            if (c == 'o') {
                for (b = 0; b < MAXNB; b++) {
                    // IMPROVE should check if the board is a DT5790
