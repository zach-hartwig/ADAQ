...
int ProgramDigitizer(int handle, DigitizerParams_t Params, CAEN_DGTZ_DPP_CI_Params_t DPPParams)
{
    ...
    DPP-CI can save:
    2 analog waveforms:
        the first is always the input signal;
        the second can be specified with the VIRTUALPROBE parameter
    4 digital waveforms:
    ...
    CAEN_DGTZ_DPP_CI_DIGITALPROBE1(2)_BlOutSafeBand
    CAEN_DGTZ_DPP_CI_DIGITALPROBE1(2)_BlTimeout
    CAEN_DGTZ_DPP_CI_DIGITALPROBE1(2)_CoincidenceMet
    CAEN_DGTZ_DPP_CI_DIGITALPROBE1(2)_Tvaw */ 
    ret |= CAEN_DGTZ_SetDPP_CI_VirtualProbe(handle, CAEN_DGTZ_DPP_VIRTUALPROBE_SINGLE, CAEN_DGTZ_DPP_CI_VIRTUALPROBE_Baseline, CAEN_DGTZ_DPP_CI_DIGITALPROBE1_BlOutSafeBand, CAEN_DGTZ_DPP_CI_DIGITALPROBE2_Tvaw);
    if (ret) {
