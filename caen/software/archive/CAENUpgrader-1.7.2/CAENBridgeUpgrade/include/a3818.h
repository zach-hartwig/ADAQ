/*
        ...
        November 2008 : Modified for A3818
        June  2004 :   Created (a2818).
...
#define PCI_DEVICE_ID_VIRTEX      		(0x0007) // VIRTEX5
...
#define A3818_IOCTL_START_DMA_TO_PC     _IOWR(A3818_MAGIC, 10, a3818_comm_t)    // AM per debug su DMA dalla A3818 al PC
...
#define START_WRITE_DMA                 (0x01)   // AM Write to PC in DMA da togliere!!!

#define MAX_OPT_LINK 	          		(0x05)
#define A3818_COMMON_REG        		(0x05)

#define AT45DB321D_PAGE_SIZE 		264   // AUG!
...
struct a3818_state {
        ...
        wait_queue_head_t       read_wait_debug[MAX_OPT_LINK];   // AM per debug
        ...
        int                     rx_ready_debug[MAX_OPT_LINK];   // AM per debug
