/***********************************************************************
  ...
  desc: This library provides general, low-level function for
        communication with VME devices (e.g., digitizers, HV power
        supplies, ...). The library is built on the CAEN VME library
        (CAENVMElib).

  note: This header file was copied from the CAENComm-1.02 source
        code. The code has been left largely untouched although I have
        clean up the comments for readability and removed any
        reference to Windows-related code mostly for readability and
        concision but also because Windows can go suck an egg.

  original information:

    Name      CAENComm.h
    Project   CAENComm - Communication Layer
    Authors   Carlo Tintori & Alberto Lucchesi 
...
/***********************************************************************
 fn       CAENComm_OpenDevice(CAENComm_DeviceDescr dd, int *handle);
 brief   Open the device
 
 param	[IN] LinkType: the link used by the device 
             (CAENComm_USB|CAENComm_PCI_OpticalLink|CAENComm_PCIE_OpticalLink|CAENComm_PCIE)
...
/***********************************************************************
 fn      CAENComm_CloseDevice(int handle);
...
/***********************************************************************
 fn      CAENComm_Write32(int handle, uint32_t Address, uint32_t *Data)
...
/***********************************************************************
 ...
 fn      CAENComm_Write16(int handle, uint32_t Address, uint16_t *Data)
...
/***********************************************************************
 fn      CAENComm_Read32(int handle, uint32_t Address, uint32_t *Data)
...
/***********************************************************************
 fn      CAENComm_Read16(int handle, uint32_t Address, uint16_t *Data)
...
/***********************************************************************
 fn      CAENComm_MultiRead32(int handle, uint32_t Address, int nCycles, uint32_t *data, CAENComm_ErrorCode *ErrorCode)
...
/***********************************************************************
 fn      CAENComm_MultiRead16(int handle, uint32_t *Address, int nCycles, uint32_t *data, CAENComm_ErrorCode *ErrorCode)
...
/***********************************************************************
 fn      CAENComm_MultiWrite16(int handle, uint32_t *Address, int nCycles, uint32_t *data, CAENComm_ErrorCode *ErrorCode)
...
/***********************************************************************
 fn      CAENComm_MultiWrite32(int handle, uint32_t *Address, int nCycles, uint32_t *data, CAENComm_ErrorCode *ErrorCode)
 brief   The function performs a block of single 16bit WriteRegister.
...
/***********************************************************************
 fn      CAENComm_BLTRead(int handle, uint32_t Address, uint32_t *Buff, int BltSize, int *nw)
...
/***********************************************************************
 fn      CAENComm_MBLTRead(int handle, uint32_t Address, uint32_t *Buff, int BltSize, int *nw)
...
/***********************************************************************
 fn      CAENComm_VMEIRQCheck(int handle, uint8_t *Mask)
...
/***********************************************************************
 fn      CAENComm_IRQDisable(int handle)
...
/***********************************************************************
 fn      CAENComm_IRQEnable(int handle)
...
/***********************************************************************
 fn      CAENComm_VMEIACKCycle16(int VMEhandle, IRQLevels Level, int *BoardID)
...
/***********************************************************************
 fn      CAENComm_VMEIACKCycle32(int VMEhandle, IRQLevels Level, int *BoardID)
...
/***********************************************************************
 fn      CAENComm_IACKCycle(int handle, IRQLevels Level, int *BoardID)
 brief   The function performs a 16 bit VME interrupt acknowledge cycle .
...
/***********************************************************************
 fn      CAENComm_IRQWait(int handle, uint32_t Timeout)
...
/***********************************************************************
 fn      CAENComm_VMEIRQWait(int LinkType, int LinkNum, int ConetNode, uint8_t IRQMask, uint32_t Timeout, int *VMEHandle)
 brief   The function wait the IRQ until one of them raise or timeout expires.
...
/***********************************************************************
 fn      CAENComm_Info(int handle, CAENCOMM_INFO info, char *data)
...
/***********************************************************************
 fn      CAENComm_SWRelease(char *SwRel)
