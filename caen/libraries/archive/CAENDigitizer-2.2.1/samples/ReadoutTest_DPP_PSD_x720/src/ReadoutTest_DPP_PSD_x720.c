...
int ProgramDigitizer(int handle, DigitizerParams_t Params, CAEN_DGTZ_DPP_PSD_Params_t DPPParams)
{
    ...
    Digital Probes 1(2) types:
    CAEN_DGTZ_DPP_PSD_DIGITALPROBE1(2)_Armed
    CAEN_DGTZ_DPP_PSD_DIGITALPROBE1(2)_Trigger
    CAEN_DGTZ_DPP_PSD_DIGITALPROBE1(2)_ChargeReady
    CAEN_DGTZ_DPP_PSD_DIGITALPROBE1(2)_PileUp
    CAEN_DGTZ_DPP_PSD_DIGITALPROBE1(2)_BlOutSafeBand
    CAEN_DGTZ_DPP_PSD_DIGITALPROBE1(2)_BlTimeout
    CAEN_DGTZ_DPP_PSD_DIGITALPROBE1(2)_CoincidenceMet
    CAEN_DGTZ_DPP_PSD_DIGITALPROBE1(2)_Tvaw */ 
    ret |= CAEN_DGTZ_SetDPP_PSD_VirtualProbe(handle, CAEN_DGTZ_DPP_VIRTUALPROBE_SINGLE, CAEN_DGTZ_DPP_PSD_VIRTUALPROBE_Threshold, CAEN_DGTZ_DPP_PSD_DIGITALPROBE1_Armed, CAEN_DGTZ_DPP_PSD_DIGITALPROBE2_Trigger);
    ...
    for(b=0; b<MAXNB; b++) {
        ...
        *      DPP parameters        *
        ...
        for(ch=0; ch<MaxNChannels; ch++) {
            ...
            DPPParams[b].lgate[ch] = 10;    // Long Gate Width (N*4ns)
            DPPParams[b].sgate[ch] = 5;    // Short Gate Width (N*4ns)
            DPPParams[b].pgate[ch] = 70;     // Pre Gate Width (N*4ns)
            /* Self Trigger Mode:
            0 -> Disabled
            1 -> Enabled */
