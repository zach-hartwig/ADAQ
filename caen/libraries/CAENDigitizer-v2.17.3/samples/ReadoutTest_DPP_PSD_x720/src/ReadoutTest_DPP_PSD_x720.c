...
int main(int argc, char *argv[])
{
    ...
    for(b=0; b<MAXNB; b++) {
        ...
        *  Acquisition parameters    *
        ...
        Params[b].RecordLength = 12;                              // Num of samples of the waveforms (only for Oscilloscope mode) -> Nsamples = Recordlength * 8
        ...
        *      DPP parameters        *
        ...
        DPPParams[b].purgap = 100;  // Purity Gap in LSB (1LSB = 0.49 mV)
